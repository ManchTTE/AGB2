...
#define trigPin 6                                     // Pin 12 trigger output
...
// Print a message to the LCD.
	lcd.print("Hello !!!"); //ฟังก์ชั่นใ นการกำหนดข้อความที่ต้องการแสดงผล
...
void loop()
{
    ...
    lcd.print(echo_duration / 58);               // Print the distance in centimeters
//    plot(echo_duration / 58);
    delay(10);   // every 100 mS
    lcd.clear();
}
